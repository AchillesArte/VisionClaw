...
class GeminiSessionViewModel: ObservableObject {
  ...
  func startSession() async {
    ...
    guard GeminiConfig.isConfigured else {
      errorMessage = "Gemini API key not configured (key length: \(GeminiConfig.apiKey.count), starts with: \(String(GeminiConfig.apiKey.prefix(8)))). Open GeminiConfig.swift and set your key from https://aistudio.google.com/apikey"
      return
    }
